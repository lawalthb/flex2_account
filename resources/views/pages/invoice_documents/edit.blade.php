                    ...
                    <div  class="card-1 border rounded page-content" >
                        ...
                        <div>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="comment">{{ __('comment') }} <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-comment-holder" class=" ">
                                            <textarea placeholder="{{ __('enterComment') }}" id="ctrl-comment" data-field="comment"  required="" rows="5" name="comment" class=" form-control"><?php  echo $data['comment']; ?></textarea>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="customer_legder_id">{{ __('customerLegderId') }} <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-sm-8">
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="sales_ledger_id">{{ __('salesLedgerId') }} <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-sm-8">
