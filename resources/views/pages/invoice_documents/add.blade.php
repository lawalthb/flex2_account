            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="invoice_documents-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('invoice_documents.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-comment-holder" class=" ">
                                                <textarea placeholder="{{ __('enterComment') }}" id="ctrl-comment" data-field="comment"  required="" rows="5" name="comment" class=" form-control"><?php echo get_value('comment') ?></textarea>
