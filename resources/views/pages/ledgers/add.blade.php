            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="ledgers-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('ledgers.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-marketer_id-holder" class=" ">
                                                <input id="ctrl-marketer_id" data-field="marketer_id"  value="<?php echo get_value('marketer_id', "0") ?>" type="number" placeholder="{{ __('enterMarketerId') }}" step="any"  required="" name="marketer_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-opening_balance-holder" class=" ">
                                                <input id="ctrl-opening_balance" data-field="opening_balance"  value="<?php echo get_value('opening_balance', "0.00") ?>" type="number" placeholder="{{ __('enterOpeningBalance') }}" step="0.1"  required="" name="opening_balance"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
