            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="products-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('products.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-exp_date-holder" class="input-group ">
                                                <input id="ctrl-exp_date" data-field="exp_date" class="form-control datepicker  datepicker"  value="<?php echo get_value('exp_date', "NULL") ?>" type="datetime" name="exp_date" placeholder="{{ __('enterExpDate') }}" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                <span class="input-group-text"><i class="material-icons">date_range</i></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-dead_stock-holder" class=" ">
                                                <input id="ctrl-dead_stock" data-field="dead_stock"  value="<?php echo get_value('dead_stock', "0") ?>" type="number" placeholder="{{ __('enterDeadStock') }}" step="any"  required="" name="dead_stock"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
